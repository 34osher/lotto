...
namespace ReadFromExcel // Note: actual namespace depends on the project name.
{
     internal class Lotto_v1
    {
        ...
        public static int[] RandomNun(int[] p)
        {
        ...
        public static int Check1(int[] w) //onle one number in the array
        {
        ...
        public static int Check2(int[] r)
        {
            //Simmolarity = 0;
            int Count = 0;
            int te = 0;
        ...
        public static int Check3(int v, int[] l)
        {
